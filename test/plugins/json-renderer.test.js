...
import { naiveUIComponentNames, customComponents, getNaiveUIComponents, getAllComponents, isComponentRegistered, getRegisteredComponentNames } from '@/plugins/json-renderer';
describe('JSON 渲染器插件 - 组件注册', () => {
    ...
    describe('Property 1: 组件注册完整性', () => {
        ...
        test.prop([fc.constantFrom(...naiveUIComponentNames)], { numRuns: 100 })('对于任意 NaiveUI 组件名，应该能在注册表中找到', (componentName) => {
        ...
        test.prop([fc.constantFrom(...Object.keys(customComponents))], { numRuns: 100 })('对于任意自定义组件名，应该能在注册表中找到', (componentName) => {
        ...
        test.prop([fc.constantFrom(...getRegisteredComponentNames())], { numRuns: 100 })('对于任意已注册组件名，isComponentRegistered 应返回 true', (componentName) => {
        ...
        test.prop([fc.string().filter(s => !getRegisteredComponentNames().includes(s) && s.length > 0)], { numRuns: 100 })('对于任意未注册的组件名，isComponentRegistered 应返回 false', (componentName) => {
