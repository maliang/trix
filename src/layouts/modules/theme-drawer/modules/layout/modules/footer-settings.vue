...
<template>
  <NDivider>{{ $t('theme.footer.title') }}</NDivider>
  <TransitionGroup tag="div" name="setting-list" class="flex-col-stretch gap-12px">
    <SettingItem key="1" :label="$t('theme.footer.visible')">
    ...
    <SettingItem v-if="themeStore.footer.visible" key="3" :label="$t('theme.footer.height')">
