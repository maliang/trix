...
import { AdminLayout, LAYOUT_SCROLL_EL_ID } from '@trix/materials';
import type { LayoutMode } from '@trix/materials';
...
// 如果登录页没有加载远程主题配置，在平台布局加载时尝试加载
onMounted(async () => {
  if (!themeStore.isRemoteConfigLoaded()) {
