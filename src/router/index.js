 ...
 */
export async function setupRouter(app, guardOptions) {
    // 设置路由守卫
...
// 导出辅助函数
export { isJsonRendererRoute, isAuthRequired, getLayoutType, getOpenType, getHref, getRouteTitle, isDefaultAfterLogin, getDefaultAfterLoginRoutes as getDefaultAfterLoginRoutesFromConfig } from './helper';
