 ...
 */
export function isJsonRendererRoute(route) {
 ...
 */
export function isAuthRequired(route) {
    const meta = 'meta' in route ? route.meta : undefined;
 ...
 */
export function getLayoutType(route) {
    const meta = 'meta' in route ? route.meta : undefined;
 ...
 */
export function getOpenType(route) {
    const meta = 'meta' in route ? route.meta : undefined;
 ...
 * @returns 是否为默认页面
 */
export function isDefaultAfterLogin(route) {
    const meta = 'meta' in route ? route.meta : undefined;
 ...
 * @returns 是否隐藏
 */
export function isHiddenInMenu(route) {
    const meta = 'meta' in route ? route.meta : undefined;
 ...
 * @returns 是否缓存
 */
export function isKeepAlive(route) {
    const meta = 'meta' in route ? route.meta : undefined;
 ...
 * @returns 默认显示页面的路由列表
 */
export function getDefaultAfterLoginRoutes(routes) {
    const result = [];
