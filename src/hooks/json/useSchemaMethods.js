...
export function useSchemaMethods() {
     ...
     */
    async function $download(urlOrBlob, filename, options) {
        let blob;
     ...
     */
    const $message = {
        success: (content, options) => window.$message?.success(content, options),
        error: (content, options) => window.$message?.error(content, options),
        warning: (content, options) => window.$message?.warning(content, options),
        info: (content, options) => window.$message?.info(content, options),
        loading: (content, options) => window.$message?.loading(content, options),
    ...
    const $dialog = {
        ...
        create: (options) => window.$dialog?.create(options),
        destroyAll: () => window.$dialog?.destroyAll()
    };
    const $notification = {
        success: (options) => window.$notification?.success(options),
        error: (options) => window.$notification?.error(options),
        warning: (options) => window.$notification?.warning(options),
        info: (options) => window.$notification?.info(options),
        create: (options) => window.$notification?.create(options),
