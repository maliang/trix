...
const safelist = [
    ...
    // ==================== 间距 ====================
    ...['p', 'm', 'px', 'py', 'mx', 'my', 'pt', 'pb', 'pl', 'pr', 'mt', 'mb', 'ml', 'mr'].flatMap(prefix => [0, 1, 2, 3, 4, 5, 6, 8, 10, 12, 14, 16, 20, 24, 28, 32].map(n => `${prefix}-${n}`)),
    // 负间距
    ...['m', 'mx', 'my', 'mt', 'mb', 'ml', 'mr'].flatMap(prefix => [1, 2, 3, 4, 5, 6, 8].map(n => `-${prefix}-${n}`)),
    // ==================== 宽高 ====================
    ...
    ...['gray', 'red', 'orange', 'yellow', 'green', 'teal', 'blue', 'indigo', 'purple', 'pink'].flatMap(color => [50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map(n => `text-${color}-${n}`)),
    // ==================== 背景 ====================
    'bg-primary', 'bg-success', 'bg-warning', 'bg-error', 'bg-info',
    'bg-white', 'bg-black', 'bg-transparent',
    ...['gray', 'red', 'orange', 'yellow', 'green', 'teal', 'blue', 'indigo', 'purple', 'pink'].flatMap(color => [50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map(n => `bg-${color}-${n}`)),
    ...
    ...['gray', 'red', 'blue', 'green'].flatMap(color => [100, 200, 300, 400, 500].map(n => `border-${color}-${n}`)),
    // 圆角
